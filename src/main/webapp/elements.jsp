	...
	<section class="sample-text-area">
		<div class="container">
			...
			<p class="sample-text">
				...
				<sub>Subscript</sub> âin the canâ (no easy feat), how do you move from a
				<del>Strike</del> through of master DVDs with the
				<u>âUnderlineâ</u> marked hand-written title inside a secondhand CD case, to a pile of cardboard boxes full of shiny new,
	...
	<div class="whole-wrap">
		<div class="container">
			...
			<div class="section-top-border text-right">
				...
				<div class="row">
					<div class="col-md-9">
						<p class="text-right">Over time, even the most sophisticated, memory packed computer can begin to run slow if we donât do something to prevent
						...
						<p class="text-right">Before we discuss all of the things that could be affecting your PCâs performance, letâs talk a little about what symptoms</p>
					</div>
					<div class="col-md-3">
						<img src="img/elements/d.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<blockquote class="generic-blockquote">
							âRecently, the US Federal government banned online casinos from operating in America by making it illegal to transfer money
